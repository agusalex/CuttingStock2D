...
writeFile("poster.txt", posterToTxt(posters))
writeFile("cantidadPosterA.txt", str(cantPostersA))
writeFile("cantidadPosterB.txt", str(cantPostersB))
writeFile("cantidadPosterC.txt", str(cantPostersC))
